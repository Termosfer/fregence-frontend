    ...
    <div className="py-10 px-4 sm:px-8 lg:px-20 font-[Playfair] bg-white min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="w-full lg:w-[350px] xl:w-[450px] bg-gray-50 border border-gray-100 rounded-3xl p-10 h-fit shadow-2xl shadow-gray-100/50">
          ...
          <Link
            to="/checkout"
            className="relative inline-flex items-center justify-center w-full h-[60px] bg-black text-white rounded-2xl overflow-hidden group cursor-pointer mt-10 shadow-lg active:scale-[0.98] transition-transform"
          >
