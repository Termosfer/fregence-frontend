    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative w-full h-[85vh] lg:h-screen overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white z-10 px-4">
          ...
          >
            The Art of{" "}
            <span className="italic font-bold text-[#81d8d0]">Scent</span>
          </motion.h1>
          ...
          >
            <Link
              to="/products"
              className="group relative px-12 py-4 border border-white overflow-hidden inline-block"
            >
              <span className="relative z-10 text-xs font-bold tracking-[3px] group-hover:text-black transition-colors duration-500 uppercase">
                Explore Collection
              </span>
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex gap-4">
              {scentCards?.map((_, i) => (
                <div key={i} className="w-12 h-[2px] bg-white/20" />
              ))}
            </div>
          </div>
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            {scentCards?.map((card, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -20 }}
                className="relative h-[450px] rounded-[3rem] overflow-hidden group"
              >
                <img
                  src={card.img}
                ...
                <h4 className="absolute bottom-10 left-1/2 -translate-x-1/2 font-bold uppercase tracking-[4px] text-xs text-nowrap">
                  {card.title}
                </h4>
              </motion.div>
            ))}
          ...
          {isLoading
                  ...
                  <div className="relative aspect-[3/4] overflow-hidden rounded-[2.5rem] bg-[#fdfdfd] border border-gray-100 shadow-sm transition-all duration-700 group-hover:shadow-2xl">
                    ...
                    <div className="absolute top-6 right-6 flex flex-col gap-3 z-30">
                      {[
                        {
                          icon: <FiSearch />,
                          action: () => handleOpenQuickView(item.id),
                          delay: "delay-100",
                        },
                        {
                          icon: <FiHeart />,
            ...
            `}
                  ...
                  <div className="mt-6 text-center">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-gray-900 uppercase tracking-tight mt-1 hover:text-[#81d8d0] transition-colors">
                        {item.name}
                      </h4>
                    </div>
