    ...
    <div className="space-y-10 font-[Playfair]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat) => (
          ...
          >
            <div
              className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl ${stat.color} shadow-sm`}
            >
              {stat.icon}
            </div>
            <div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-bold text-gray-700 uppercase tracking-tighter">
                Average Order: {stats?.averageOrderValue} Azn
              </span>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span className="text-sm font-bold text-gray-700 uppercase tracking-tighter">
                Customer Growth: +{stats?.customerGrowthRate}%
              </span>
            </div>
            <div className="flex items-center gap-4">
